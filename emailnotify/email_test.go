...
func TestSendEmail(t *testing.T) {
	email := NewMail(WithAccountUserName("wang.hongning@uneed.com"),
		WithAccountPasswd("xxxxxxxxxxxxxxx"), WithSMTPHost("smtp.exmail.qq.com"),
		WithSMTPPort(465))
	if err := email.To.Add("hongning", "wang.hongning@uneed.com"); err != nil {
		t.Fatal(err)
	}
